...
public class Producto {
    ...
    // Constructor público para crear objetos de tipo Producto con los campos
    // necesarios
    ...
    // Getters para acceder a los atributos (necesarios para el funcionamiento de
    // JPA y buenas prácticas)
    public Long getId() {
        return id;
    }
    ...
    // Método que permite imprimir el objeto de forma legible (útil para logs o
    // consola)
    @Override
