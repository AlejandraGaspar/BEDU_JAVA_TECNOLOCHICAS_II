...
public class TiendaApplication {
	...
	public CommandLineRunner demo(ProductoRepository productoRepo, CategoriaRepository categoriaRepo) {
		return (args) -> {
			...
			productoRepo.save(
					new Producto("Laptop ASUS ROG Strix SCAR 18", "Intel Core i9, RTX 5090", 90000.00, tecnologia));
			...
			productoRepo.findAll()
					.forEach(p -> System.out.println(p.getNombre() + " - " + p.getCategoria().getNombre()));
		};
	}
